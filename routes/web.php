...
Route::middleware(['company:company'])->group(function () {
    ...
    Route::get('/company/print/{id}', [CompanyController::class, 'Print'])->name('print.resume');
    Route::post('/inerview/date', [CompanyController::class, 'interviewDate'])->name('inerview.date');
    Route::get('/company/reports', [CompanyController::class, 'company_report'])->name('company_candidate_report');
...
Route::middleware(['candidate:candidate'])->group(function () {
    ...
    Route::get('/candidate/interviews', [CandidateController::class, 'Interviews'])->name('candidate.interviews');
