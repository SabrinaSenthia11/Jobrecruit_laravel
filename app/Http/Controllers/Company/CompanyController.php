...
class CompanyController extends Controller
{
    ...
    {
        $total_opened_jobs = Job::where('company_id', FacadesAuth::guard('company')->user()->id)->count();
        $total_featured_jobs = Job::where('company_id', FacadesAuth::guard('company')->user()->id)->where('is_featured', 1)->count();
        $jobs = Job::with('rJobCategory')->where('company_id', FacadesAuth::guard('company')->user()->id)->orderBy('id', 'desc')->take(2)->get();
        return view('company.dashboard', compact('jobs', 'total_opened_jobs', 'total_featured_jobs'));
    }

    public function orders()
    {
        $orders = Order::with('rPackage')->orderBy('id', 'desc')->where('company_id', FacadesAuth::guard('company')->user()->id)->get();
    ...
    {
        $obj = Company::where('id', FacadesAuth::guard('company')->user()->id)->first();
        $id = $obj->id;
        ...
        if ($request->hasFile('logo')) {
            ...
            if (FacadesAuth::guard('company')->user()->logo != '') {
    ...
    public function photos()
    {
        ...
        $order_data = Order::where('company_id', FacadesAuth::guard('company')->user()->id)->where('currently_active', 1)->first();
        ...
        $photos = CompanyPhoto::where('company_id', FacadesAuth::guard('company')->user()->id)->get();
    ...
    public function photos_submit(Request $request)
    {
        $order_data = Order::where('company_id', FacadesAuth::guard('company')->user()->id)->where('currently_active', 1)->first();
        $package_data = Package::where('id', $order_data->package_id)->first();
        $existing_photo_number = CompanyPhoto::where('company_id', FacadesAuth::guard('company')->user()->id)->count();
        ...
        $obj->company_id = FacadesAuth::guard('company')->user()->id;
        $obj->save();
    ...
    public function videos()
    {
        ...
        $videos = CompanyVideo::where('company_id', FacadesAuth::guard('company')->user()->id)->get();
    ...
    public function videos_submit(Request $request)
    {
        $order_data = Order::where('company_id', FacadesAuth::guard('company')->user()->id)->where('currently_active', 1)->first();
        $package_data = Package::where('id', $order_data->package_id)->first();
        $existing_video_number = CompanyVideo::where('company_id', FacadesAuth::guard('company')->user()->id)->count();
    ...
    {
        $current_plan = Order::with('rPackage')->where('company_id', FacadesAuth::guard('company')->user()->id)->where('currently_active', 1)->first();
    ...
    public function paypal_success(Request $request)
    {
        ...
        if (isset($response['status']) && $response['status'] == 'COMPLETED') {
            ...
            Order::where('company_id', FacadesAuth::guard()->user()->id)->update($data);

            $obj = new Order();
            $obj->company_id = FacadesAuth::guard()->user()->id;
    ...
    public function jobs_create()
    {
        ...
        $total_jobs_posted = Job::where('company_id', FacadesAuth::guard('company')->user()->id)->count();
    ...
    {
        $jobs = Job::with('rJobCategory')->where('company_id', FacadesAuth::guard('company')->user()->id)->get();
    ...
    {
        $jobs = Job::with('rJobCategory', 'rJobLocation', 'rJobType', 'rJobGender', 'rJobExperience', 'rJobSalaryRange')->where('company_id', FacadesAuth::guard('company')->user()->id)->get();
    ...
    public function print($id)
    {
        ...
        return view('company.print', compact('candidate_single', 'candidate_educations', 'candidate_experiences', 'candidate_skills', 'candidate_awards', 'candidate_resumes'));
    ...
    public function interviewDate(Request $request){
        ...
        $interview->datetime = $request->datetime;
    ...
    public function company_report()
    {
        ...
        return view('company.reports', compact('jobs'));
