...
@section('button')
<div>
    <a href="{{ route('admin_job_location_create') }}" class="btn btn-success"><i class=""></i> Add New</a>
</div>
@endsection
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="pt_10 pb_10">
                                        <a href="{{ route('admin_job_location_edit',$item->id) }}" class="btn btn-success btn-sm">Edit</a>
