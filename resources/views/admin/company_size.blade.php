...
@section('button')
<div>
    <a href="{{ route('admin_company_size_create') }}" class="btn btn-dark"><i class=""></i> Add New</a>
</div>
@endsection
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="pt_10 pb_10">
                                        <a href="{{ route('admin_company_size_edit',$item->id) }}" class="btn btn-success btn-sm">Edit</a>
