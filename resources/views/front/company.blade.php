                ...
                <div class="item d-flex justify-content-start">
                    ...
                    <div class="text">
                        ...
                        <div class="detail-1 d-flex justify-content-start">
                            <div class="category">{{ $company_single->rCompanyIndustry ? $company_single->rCompanyIndustry->name : 'N/A' }}</div>
                            <div class="location">{{ $company_single->rCompanyLocation ? $company_single->rCompanyLocation->name : 'N/A' }}</div>
                    ...
                    <div class="summary">
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td><b> Industry:</b></td>
                                    <td>{{ $company_single->rCompanyIndustry ? $company_single->rCompanyIndustry->name : 'N/A' }}</td>
                                </tr>
                                <tr>
                                    <td><b> Location:</b></td>
                                    <td>{{ $company_single->rCompanyLocation ? $company_single->rCompanyLocation->name : 'N/A' }}</td>

                                </tr>
                                <tr>
                                    <td><b>Company Size:</b></td>
                                    <td>{{ $company_single->rCompanySize ? $company_single->rCompanySize->name : 'N/A' }}</td>
