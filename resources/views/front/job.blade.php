                ...
                <div class="item d-flex justify-content-start">
                    ...
                    <div class="text">
                        ...
                        <div class="detail-2 d-flex justify-content-start">
                            ...
                            <div class="expired" style="color: white;">
                                Deadline {{ $job_single->deadline }}
                            </div>
                            @if(date('Y-m-d') > $job_single->deadline)
                            <div class="expired">
                                Expired on {{ $job_single->deadline }}
                            </div>
                            @endif
                        ...
                        <div class="apply">
                            @if(date('Y-m-d') <= $job_single->deadline)
                                ...
                                <a href="{{ route('candidate_bookmark_add',$job_single->id) }}" class="btn btn-success save-job">Bookmark</a>
                                @endif
                        </div>
                        @endif
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-12">
                ...
                <div class="left-item">
                    <h2><i class="fas fa-file-invoice"></i> Source</h2>
                    {!! $job_single->skill !!}
                </div>
